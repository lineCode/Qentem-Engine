...
Array<TestBit> Qentem::Test::GetBits() noexcept {
    ...
    bit.Content.Add(L"<br><s><br>"); //<div> <span> str1 <br> str2 </span> </div><br>
    ...
    bit.Content.Add(L"<span>ae<span>str0</span></spans>"); // TODO: diva
    bit.Expected.Add(L"<span>ae(str0)</spans>");

    bit.Content.Add(L"<div>ae<span>str0</span></div>"); // TODO: diva
    bit.Expected.Add(L"(ae(str0))");
