...
static String SubMatchZero(const String &, const Match &) noexcept;
...
static String SubMatchNestMatch(const String &block, const Match &item) noexcept {
    String nc = L"";
    if (item.SubMatch.Size != 0) {
...
static String SubMatchZero(const String &block, const Match &item) noexcept {
    Match *sm = &(item.SubMatch.Storage[0]);
